...
from pyeumap.lucas.exceptions import LucasDataError, LucasLoadError


class LucasClassAggr:
    """Perform LC class aggregation.

    :param str gpkg_path: path to GPKG file created by :class:`pyeumap.lucas.io.LucasIO.to_gpkg()`.
    """
