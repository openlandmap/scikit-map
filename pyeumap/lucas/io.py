...
from pyeumap.lucas.logger import Logger
from pyeumap.lucas.exceptions import LucasDownloadError, LucasDataError
...
class LucasIO:
    ...
    def download(self, request):
        ...
        specified request :class:`pyeumap.lucas.request.LucasRequest`.
