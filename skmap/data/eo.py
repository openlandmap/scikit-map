        ...
        def _bbox_and_footprint(self, raster_fn):
            ...
            with rasterio.Env(**self.gdal_env) as rio_env:
                with rasterio.open(raster_fn) as ds:
                    transformer = Transformer.from_crs(ds.crs, "epsg:4326", always_xy=False)
                    bounds = ds.bounds
                    ...
                    elif ds.crs == "EPSG:4326":        
                        left_wgs84, bottom_wgs84 = transformer.transform(bounds.bottom, bounds.left)
                        right_wgs84, top_wgs84 = transformer.transform(bounds.top, bounds.right)
                        bottom_wgs84_tmp = bottom_wgs84
                        bottom_wgs84 = left_wgs84
                        left_wgs84 = bottom_wgs84_tmp
                        
                        top_wgs84_tmp = top_wgs84
                        top_wgs84 = right_wgs84
                        right_wgs84 = top_wgs84_tmp
                    else:
                        left_wgs84, bottom_wgs84 = transformer.transform(bounds.bottom, bounds.left)
                        right_wgs84, top_wgs84 = transformer.transform(bounds.top, bounds.right)
                        print("WARNING: this projection might not have the correct bounding box")
                        bottom_wgs84_tmp = bottom_wgs84
                        bottom_wgs84 = left_wgs84
                        left_wgs84 = bottom_wgs84_tmp
