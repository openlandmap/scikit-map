...
tr[[2]]
```
3rd element is the summary of the *trained model*. Note that the *R squared (OOB)* is shows performance evaluation of the model during training which sample fraction for different batches varies from 50% to 70%.
